...
export type LlamaCppModelRecord = WithModelPricing<FromSchema<typeof LlamaCppModelRecordSchema>>;
...
export type LlamaCppModelConfig = WithModelPricing<FromSchema<typeof LlamaCppModelConfigSchema>>;
