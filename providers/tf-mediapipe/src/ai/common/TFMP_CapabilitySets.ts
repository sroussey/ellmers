...
export const TFMP_MODEL_UNLOAD = ["model.unload"] as const satisfies Capability[];
export const TFMP_MODEL_SEARCH = ["provider.model-search"] as const satisfies Capability[];
export const TFMP_MODEL_INFO = ["provider.model-info"] as const satisfies Capability[];
