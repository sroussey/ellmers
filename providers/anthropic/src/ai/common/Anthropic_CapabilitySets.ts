...
export const ANTHROPIC_MODEL_SEARCH = ["provider.model-search"] as const satisfies Capability[];
export const ANTHROPIC_MODEL_INFO = ["provider.model-info"] as const satisfies Capability[];
