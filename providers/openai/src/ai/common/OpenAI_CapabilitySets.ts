 ...
 */
export const OPENAI_TEXT_GENERATION = ["text.generation"] as const satisfies readonly Capability[];
export const OPENAI_TOOL_USE = [
  "text.generation",
  "tool-use",
] as const satisfies readonly Capability[];
export const OPENAI_JSON_MODE = [
  "text.generation",
  "json-mode",
] as const satisfies readonly Capability[];
export const OPENAI_TEXT_REWRITER = ["text.rewriter"] as const satisfies readonly Capability[];
export const OPENAI_TEXT_SUMMARY = ["text.summary"] as const satisfies readonly Capability[];
export const OPENAI_TEXT_EMBEDDING = ["text.embedding"] as const satisfies readonly Capability[];
export const OPENAI_IMAGE_GENERATION = [
  "image.generation",
] as const satisfies readonly Capability[];
export const OPENAI_IMAGE_EDITING = ["image.editing"] as const satisfies readonly Capability[];
export const OPENAI_COUNT_TOKENS = [
  "model.count-tokens",
] as const satisfies readonly Capability[];
export const OPENAI_MODEL_SEARCH = [
  "provider.model-search",
] as const satisfies readonly Capability[];
export const OPENAI_MODEL_INFO = ["provider.model-info"] as const satisfies readonly Capability[];
