...
export const OPENAI_MODEL_SEARCH = ["provider.model-search"] as const satisfies Capability[];
export const OPENAI_MODEL_INFO = ["provider.model-info"] as const satisfies Capability[];
