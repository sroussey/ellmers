...
export const OLLAMA_MODEL_SEARCH = ["provider.model-search"] as const satisfies Capability[];
export const OLLAMA_MODEL_INFO = ["provider.model-info"] as const satisfies Capability[];
