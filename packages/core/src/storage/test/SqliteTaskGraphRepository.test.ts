...
import { SqliteTaskGraphRepository } from "../taskgraph/SqliteTaskGraphRepository";
...
describe("SqliteTaskGraphRepository", () => {
  let repository: SqliteTaskGraphRepository;

  beforeEach(() => {
    repository = new SqliteTaskGraphRepository(":memory:");
  });
